...
FINAL_CHUNKS = 35    # Final chunks after sentence extraction
DB_PATH = "chromadb"
...
def optimized_hybrid_search_with_dense_reranking(query, collection_name):
    ...
    final_candidates.sort(key=lambda x: x["enhanced_score"], reverse=True)
...
if __name__ == "__main__":
    ...
    # Process each query
    collection_name = "zurich_insurance_ocr_pages_heading_semantic"
    
    # Initialize CSV file
    csv_filename = "Zurich_Insurance_Exhaustive_30Q6v5.csv"
    csv_headers = [
