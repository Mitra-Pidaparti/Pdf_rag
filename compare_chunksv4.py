...
Rate the percentage (0-100) of benchmark information that is present exactly or semantically in the system content.
Return only the number."""
    ...
    def calculate_adaptive_coverage(self, benchmark_chunk: Dict, contributing_chunks: List[Dict]) -> float:
        ...
        if num_chunks >= 2:
            ...
            if (top_score >= 40.0) or (sum_coverage >= 50.0):
