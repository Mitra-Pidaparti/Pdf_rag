    ...
    try:
        ...
        for i, candidate in enumerate(candidates):
            ...
            candidate["neural_enhanced_score"] = (
                ...
                0.3 * candidate["semantic_score"] +  # Dense semantic
                0.5 * candidate["neural_score"]      # Neural reranking (highest weight)
            )
...
def enhance_with_basic_context_features(chunks, query):
    ...
    for chunk in chunks:
        ...
        chunk["final_enhanced_score"] = chunk["neural_enhanced_score"] + context_bonus
...
if __name__ == "__main__":
    ...
    csv_filename = "Novartis_extraction_neural_rerank.csv"
    csv_headers = [
