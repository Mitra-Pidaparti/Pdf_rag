...
# Configuration
# -------------------------
INITIAL_POOL_SIZE = 30  # Large pool from BM25/TF-IDF
DENSE_RERANK_SIZE = 20  # Candidates after dense reranking
NEURAL_RERANK_SIZE = 10  # Candidates after neural reranking
FINAL_CHUNKS = 5  # Final chunks after sentence extraction
DB_PATH = "chromadb"
...
# -------------------------
def optimized_hybrid_search_with_neural_reranking(query, keywords_list, collection_name):
    """
    Enhanced hybrid search pipeline with neural reranking:
...
if __name__ == "__main__":
    ...
    csv_filename = "Novartis_extraction_neural_rerankQ1_expt.csv"
    csv_headers = [
    ...
    for query_idx, query in enumerate(queries):
        ...
        try:
            ...
            results = optimized_hybrid_search_with_neural_reranking(query, query_keywords, collection_name)
    ...
    print("[INFO] CSV file contains detailed scoring metrics including neural reranking scores")