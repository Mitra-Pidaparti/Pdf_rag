...
def is_heading(line: str, next_line: Optional[str] = None) -> bool:
    ...
    if not (heading_text.isupper() or heading_text.istitle() or is_mostly_capitalized(heading_text) or (first_word and first_word[0].isupper())):
        return False
...
def is_pageno(line: str) -> bool:
    ...
    """
    # Match patterns like 'Page 2', 'p. 2', '2', or surrounded by hashes, e.g., '### Page 2 ###'
